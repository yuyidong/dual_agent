...
from dual_agent.training.loops import train_forecaster_epoch
...
def main() -> None:
    ...
    for epoch in range(config.training.epochs):
        loss = train_forecaster_epoch(model, loader, optimizer, adjacency, device)
        print(f"epoch={epoch + 1:03d} forecast_loss={loss:.6f}")
